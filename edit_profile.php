<?php
  ...
  $mobile = "";
  $address = "";
  $query = "select * from student where sno = '$_SESSION[uid]'";
  ...
  if(isset($_POST['update'])){
    $query = "update student set fname='$_POST[fname]',lname='$_POST[lname]',email='$_POST[email]',password='$_POST[password]',mobile=$_POST[mobile],address='$_POST[address]' where sno=$_SESSION[uid]";
    $query_run = mysqli_query($connection,$query);
    if($query_run){
