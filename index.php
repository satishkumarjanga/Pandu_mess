<?php
  ...
  if(isset($_POST['register'])){
    include('includes/connection.php');
    $query = "insert into student values(null,'$_POST[fname]','$_POST[lname]','$_POST[email]','$_POST[password]',$_POST[mobile],'$_POST[address]',0)";
    $query_run = mysqli_query($connection,$query);
    if($query_run){
      echo "<script type='text/javascript'>
...
<html lang="en" dir="ltr">
  ...
  <body style="background:url('images/Mens.jpg');">
    <!-- Navbar -->
    <nav class="navbar navbar-expand-lg" style="background-color:#194350;">
  		<div class="container-fluid">
  		    ...
  		    <ul class="nav navbar-nav navbar-center">
  		      <li class="nav-item">
              <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#login_modal" id="login_button"> Student Login</button>
  		      </li>
